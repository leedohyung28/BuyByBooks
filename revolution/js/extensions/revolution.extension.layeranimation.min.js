...
!(function (e) {
  ...
  jQuery.extend(!0, t, {
    updateMarkup: function (e, i) {
      ...
      if (void 0 !== t.start && !t.frames_added && void 0 === t.frames) {
        ...
        jQuery.isNumeric(t.end) &&
          jQuery.isNumeric(t.start) &&
          jQuery.isNumeric(o.speed) &&
          (t.end =
            parseInt(t.end, 0) -
            (parseInt(t.start, 0) + parseFloat(o.speed, 0))),
          a.push({
            frame: "0",
            delay: t.start,
            from: t.transform_in,
      ...
      if (!t.frames_added) {
        if (
          ...
          for (var s = 0; s < t.frames.length; s++)
            void 0 !== t.frames[s].sfx_effect &&
              t.frames[s].sfx_effect.indexOf("block") >= 0 &&
              (0 === s
                ? ((t.frames[s].from = "o:0"), (t.frames[s].to = "o:1"))
                : (t.frames[s].to = "o:0"),
              (t._sfx = "block")),
              void 0 === t.frames[0].from && (t.frames[0].from = "o:inherit"),
              0 === t.frames[0].delay && (t.frames[0].delay = 20),
              "hover" === t.frames[s].frame
                ? (t.hoverframeindex = s)
                : ("frame_999" !== t.frames[s].frame &&
                    "frame_out" !== t.frames[s].frame &&
                    "last" !== t.frames[s].frame &&
                    "end" !== t.frames[s].frame) ||
                  (t.outframeindex = s),
              void 0 !== t.frames[s].split &&
                t.frames[s].split.match(/chars|words|lines/g) &&
                (t.splittext = !0);
        (t.outframeindex =
          -1 === t.outframeindex
            ? -1 === t.hoverframeindex
    ...
    handleStaticLayers: function (e, i) {
      ...
      t < 0 && (t = 0),
        a < 0 && (a = i.realslideamount),
        0 === t && a === i.realslideamount - 1 && (a = i.realslideamount + 1),
        e.data("startslide", t),
        e.data("endslide", a);
    },
    animateTheCaptions: function (e) {
      ...
      var i = e.opt,
        ...
        m = o.data("index");
      if (
        ((i.layers = i.layers || new Object()),
        (i.layers[m] = i.layers[m] || o.find(".tp-caption")),
        (i.layers.static =
          i.layers.static || i.c.find(".tp-static-layers").find(".tp-caption")),
        void 0 === i.timelines && t.createTimelineStructure(i),
        (i.conh = i.c.height()),
        (i.conw = i.c.width()),
        (i.ulw = i.ul.width()),
        (i.ulh = i.ul.height()),
        ...
        o.addClass("indebugmode"),
          ...
          i.c.find(".hglayerinfo").remove(),
          o.append(
            '<div class="helpgrid" style="width:' +
              i.gridwidth[i.curWinRange] * i.bw +
              "px;height:" +
              i.gridheight[i.curWinRange] * i.bw +
              'px;"></div>'
          );
        ...
        c.append(
          ...
          i.c.append('<div class="hglayerinfo"></div>'),
          c.append('<div class="tlhg"></div>');
      }
      void 0 !== m &&
        i.layers[m] &&
        jQuery.each(i.layers[m], function (e, a) {
          var o = jQuery(this);
          t.updateMarkup(this, i),
        ...
        i.layers.static &&
          jQuery.each(i.layers.static, function (e, a) {
            var o = jQuery(this),
              n = o.data();
            !0 !== n.hoveredstatus && !0 !== n.inhoveroutanimation
              ? (t.updateMarkup(this, i),
                t.prepareSingleCaption({
                  caption: o,
                  opt: i,
      ...
      void 0 !== i.rowzones &&
        (p = p > i.rowzones.length ? i.rowzones.length : p),
        void 0 != i.rowzones &&
          i.rowzones.length > 0 &&
          void 0 != i.rowzones[p] &&
          p >= 0 &&
          p <= i.rowzones.length &&
          i.rowzones[p].length > 0 &&
          t.setSize(i),
        s ||
          (void 0 !== d &&
            (void 0 !== m &&
              jQuery.each(i.timelines[m].layers, function (e, a) {
                var o = a.layer.data();
                ("none" !== a.wrapper && void 0 !== a.wrapper) ||
                  ("keep" == a.triggerstate && "on" === o.triggerstate
            ...
            i.timelines.staticlayers &&
              jQuery.each(i.timelines.staticlayers.layers, function (e, a) {
                var o = a.layer.data(),
                ...
                !0 !== o.hoveredstatus &&
                  ...
                  (void 0 !== l &&
                    ...
                    ("keep" == f
                      ...
                      : !0 !== o.hoveredstatus && a.timeline.time(l)),
                  "reset" === f &&
                    "hidden" === g &&
                    (a.timeline.time(0), (o.animdirection = "out")),
                  r
                    ? m
                      ? p === a.lastslide &&
                        (a.timeline.play(d), (o.animdirection = "in"))
                      : (c || "in" === o.animdirection || a.timeline.play(s),
                        (("visible" == g && "keep" !== f) ||
                          ("keep" === f && !0 === m) ||
                          ("visible" == g && void 0 === m)) &&
                          (a.timeline.play(s + 0.01), (o.animdirection = "in")))
                    : n && m && a.timeline.play("frame_999"));
              }))),
        void 0 != n &&
          setTimeout(function () {
            n.resume();
    ...
    prepareSingleCaption: function (e) {
      ...
      if (
        ((o._pw = void 0 === o._pw ? a.closest(".tp-parallax-wrap") : o._pw),
        (o._lw = void 0 === o._lw ? a.closest(".tp-loop-wrap") : o._lw),
        (o._mw = void 0 === o._mw ? a.closest(".tp-mask-wrap") : o._mw),
        ...
        (o._lig =
          void 0 === o._lig
            ? a.hasClass("rev_layer_in_group")
              ? a.closest(".rev_group")
              : a.hasClass("rev_layer_in_column")
              ? a.closest(".rev_column_inner")
              : a.hasClass("rev_column_inner")
              ? a.closest(".rev_row")
              : "none"
            : o._lig),
        (o._column =
        ...
        (o._ingroup =
          void 0 === o._ingroup
            ? !(a.hasClass("rev_group") || !a.closest(".rev_group"))
            : o._ingroup),
        (o._isgroup =
          void 0 === o._isgroup ? !!a.hasClass("rev_group") : o._isgroup),
        (o._nctype = o.type || "none"),
        (o._cbgc_auto =
          void 0 === o._cbgc_auto
            ? "column" === o._nctype && o._pw.find(".rev_column_bg_auto_sized")
            : o._cbgc_auto),
        (o._cbgc_man =
          void 0 === o._cbgc_man
            ...
            : o._cbgc_man),
        (o._slideid =
          o._slideid || a.closest(".tp-revslider-slidesli").data("index")),
        (o._id = void 0 === o._id ? a.data("id") || a.attr("id") : o._id),
        (o._slidelink =
          void 0 === o._slidelink
            ? void 0 !== a.hasClass("slidelink") && a.hasClass("slidelink")
            : o._slidelink),
        void 0 === o._li &&
          (a.hasClass("tp-static-layer")
            ? ((o._isstatic = !0),
              (o._li = a.closest(".tp-static-layers")),
              (o._slideid = "staticlayers"))
            : (o._li = a.closest(".tp-revslider-slidesli"))),
        (o._row =
          void 0 === o._row
            ? "column" === o._nctype && o._pw.closest(".rev_row")
            : o._row),
        void 0 === o._togglelisteners && a.find(".rs-toggled-content")
        ...
        a.on("hover, mouseenter", function () {
          var e = "";
          a.data() &&
            jQuery.each(a.data(), function (i, t) {
              "object" != typeof t &&
                (e =
                  e +
      ...
      if (
        ("off" ===
          (void 0 === o.visibility
            ? "oon"
            : y(o.visibility, r)[r.forcedWinRange] ||
              y(o.visibility, r) ||
              "ooon") ||
        ...
        (o.layertype = "image"),
          ...
          void 0 == w.data("ww") && w.width() > 0 && w.data("ww", w.width()),
          void 0 == w.data("hh") && w.height() > 0 && w.data("hh", w.height());
        var m = w.data("ww"),
          c = w.data("hh"),
          p = "slide" == o._ba ? r.ulw : r.gridwidth[r.curWinRange],
          g = "slide" == o._ba ? r.ulh : r.gridheight[r.curWinRange];
        (m = y(w.data("ww"), r)[r.curWinRange] || y(w.data("ww"), r) || "auto"),
          (c =
            y(w.data("hh"), r)[r.curWinRange] || y(w.data("hh"), r) || "auto");
            ...
            ? ("grid" != o._ba && f
              ...
              "grid" != o._ba && h
                ? jQuery.isNumeric(c)
                  ...
                  : w.css({ height: c })
                : jQuery.isNumeric(c)
                ? w.css({ height: c * r.bh + "px" })
                : w.css({ height: c }))
            : w.css({ width: m, height: c }),
          o._ingroup &&
            "row" !== o._nctype &&
            (void 0 !== m &&
              !jQuery.isNumeric(m) &&
              ...
              m.indexOf("%") > 0 &&
              punchgs.TweenLite.set([o._lw, o._pw, o._mw], { minWidth: m }),
            void 0 !== c &&
              !jQuery.isNumeric(c) &&
              "string" === jQuery.type(c) &&
              c.indexOf("%") > 0 &&
              punchgs.TweenLite.set([o._lw, o._pw, o._mw], { minHeight: c }));
      }
      if ("slide" === o._ba) (e.offsetx = 0), (e.offsety = 0);
      else if (
        o._isstatic &&
        void 0 !== r.carousel &&
        void 0 !== r.carousel.horizontal_align &&
      ...
      if (
        ...
        if (
          ((o.layertype = "video"),
          t.manageVideoLayer && t.manageVideoLayer(a, r, n, s),
          !n && !s)
        ) {
          o.videotype;
        ...
        w.css({ display: "block" }),
          void 0 == a.data("videowidth") &&
            (a.data("videowidth", w.width()),
            a.data("videoheight", w.height()));
        var m =
            y(a.data("videowidth"), r)[r.curWinRange] ||
            y(a.data("videowidth"), r) ||
            "auto",
          c =
            y(a.data("videoheight"), r)[r.curWinRange] ||
            y(a.data("videoheight"), r) ||
            "auto";
        (m =
          "auto" === m || (!jQuery.isNumeric(m) && m.indexOf("%") > 0)
            ? "auto" === m
              ? "auto"
              : "grid" === o._ba
              ? r.gridwidth[r.curWinRange] * r.bw
              : o._gw
            : parseFloat(m) * r.bw + "px"),
          (c =
            "auto" === c || (!jQuery.isNumeric(c) && c.indexOf("%") > 0)
              ? "auto" === c
                ? "auto"
                : "grid" === o._ba
                ? r.gridheight[r.curWinRange] * r.bw
                : o._gh
              : parseFloat(c) * r.bh + "px"),
          (o.cssobj = void 0 === o.cssobj ? x(a, 0) : o.cssobj);
        var I = T(o.cssobj, r);
        if (
          ("auto" == I.lineHeight && (I.lineHeight = I.fontSize + 4),
          a.hasClass("fullscreenvideo") || L)
        ) {
          (e.offsetx = 0), (e.offsety = 0), a.data("x", 0), a.data("y", 0);
          var W = o._gh;
          "on" == r.autoHeight && (W = r.conh),
            a.css({ width: o._gw, height: W });
        } else
        ...
        ((0 == k && !L) ||
          (1 != o.forcecover && !a.hasClass("fullscreenvideo") && !L)) &&
          (w.width(m), w.height(c)),
          o._ingroup &&
            null !== o.videowidth &&
            void 0 !== o.videowidth &&
            !jQuery.isNumeric(o.videowidth) &&
            o.videowidth.indexOf("%") > 0 &&
            punchgs.TweenLite.set([o._lw, o._pw, o._mw], {
              minWidth: o.videowidth,
            });
      }
      j(a, r, 0, o._responsive),
      ...
      i(a, ".frontcorner", "left", "borderRight", "borderTopColor", R, C),
        i(
          a,
          ".frontcornertop",
          "left",
        ...
        i(a, ".backcorner", "right", "borderLeft", "borderBottomColor", R, C),
        i(a, ".backcornertop", "right", "borderLeft", "borderTopColor", R, C),
        "on" == r.fullScreenAlignForce && ((e.offsetx = 0), (e.offsety = 0)),
        "block" === o._sfx &&
          void 0 === o._bmask &&
          ((o._bmask = jQuery('<div class="tp-blockmask"></div>')),
          o._mw.append(o._bmask)),
        (o.arrobj = new Object()),
        (o.arrobj.voa = y(o.voffset, r)[r.curWinRange] || y(o.voffset, r)[0]),
        (o.arrobj.hoa = y(o.hoffset, r)[r.curWinRange] || y(o.hoffset, r)[0]),
        (o.arrobj.elx = y(o.x, r)[r.curWinRange] || y(o.x, r)[0]),
        (o.arrobj.ely = y(o.y, r)[r.curWinRange] || y(o.y, r)[0]);
      ...
      (o.eow = a.outerWidth(!0)),
        (o.eoh = a.outerHeight(!0)),
      ...
      "on" == r.fullScreenAlignForce && ((A = r.ulw), (B = r.ulh)),
        "none" !== o._lig &&
          void 0 != o._lig &&
          ((A = o._lig.width()),
          (B = o._lig.height()),
        ...
        (S =
          "center" == S || "middle" == S
            ...
            ? S * r.bw
            : S),
        d && !o._slidelink && (Q += o.eow),
        o._slidelink && (Q = 0),
        (o.calcx = parseInt(Q, 0) + e.offsetx),
        (o.calcy = parseInt(S, 0) + e.offsety - 200);
      var F = a.css("z-Index");
      ...
      if (
        ...
        "row" === o._nctype &&
          (o.columnbreak <= r.curWinRange
            ? a.addClass("rev_break_columns")
            : a.removeClass("rev_break_columns")),
        "on" == o.loopanimation &&
        ...
        punchgs.TweenLite.set(a, { y: 0 }),
          punchgs.TweenLite.set(o._cbgc_man, {
            y: parseInt(H + o._column.offset().top - a.offset().top, 0),
          }),
          punchgs.TweenLite.set(a, { y: Y });
      }
      o._ingroup &&
        "row" !== o._nctype &&
        (void 0 !== o._groupw &&
          !jQuery.isNumeric(o._groupw) &&
          o._groupw.indexOf("%") > 0 &&
          punchgs.TweenLite.set([o._lw, o._pw, o._mw], { minWidth: o._groupw }),
        void 0 !== o._grouph &&
          !jQuery.isNumeric(o._grouph) &&
          o._grouph.indexOf("%") > 0 &&
          punchgs.TweenLite.set([o._lw, o._pw, o._mw], {
            minHeight: o._grouph,
          }));
    ...
    createTimelineStructure: function (e) {
      function i(e, i, t, a) {
        ...
        ((t = t || new Object())[e.attr("id")] =
          t[e.attr("id")] || new Object()),
          "staticlayers" === a &&
            ((t[e.attr("id")].firstslide = e.data("startslide")),
            (t[e.attr("id")].lastslide = e.data("endslide"))),
          e.data("slideid", a),
          (t[e.attr("id")].defclasses = o = e[0].className),
          (t[e.attr("id")].wrapper =
            o.indexOf("rev_layer_in_column") >= 0
              ...
              ? e.closest(".rev_group")
              : "none"),
          (t[e.attr("id")].timeline = r),
          (t[e.attr("id")].layer = e),
          (t[e.attr("id")].triggerstate = e.data("lasttriggerstate")),
          (t[e.attr("id")].dchildren =
            o.indexOf("rev_row") >= 0
      ...
      (e.timelines = e.timelines || new Object()),
        e.c.find(".tp-revslider-slidesli, .tp-static-layers").each(function () {
          var t = jQuery(this),
            a = t.data("index");
          (e.timelines[a] = e.timelines[a] || {}),
            (e.timelines[a].layers = e.timelines[a].layers || new Object()),
    ...
    buildFullTimeLine: function (e) {
      var i,
        ...
        l = h();
      if (
        !(i = n.timelines[r._slideid].layers[r._id]).generated ||
        !0 === e.regenerate
      ) {
        if (
          ((a = i.timeline),
          ...
          a.clear(),
          (d.svg = void 0 != r.svg_src && o.find("svg")),
          d.svg &&
            ((r.idlesvg = g(r.svg_idle, p())),
            punchgs.TweenLite.set(d.svg, r.idlesvg.anim)),
          -1 !== r.hoverframeindex &&
            void 0 !== r.hoverframeindex &&
            !o.hasClass("rs-hover-ready"))
        ) {
          if (
            (o.addClass("rs-hover-ready"),
            (r.hovertimelines = {}),
            (r.hoveranim = _(l, r.frames[r.hoverframeindex].to)),
            (r.hoveranim = w(r.hoveranim, r.frames[r.hoverframeindex].style)),
            d.svg)
          ) {
            var m = g(r.svg_hover, p());
            void 0 != r.hoveranim.anim.color &&
              ((m.anim.fill = r.hoveranim.anim.color),
          ...
          o.hover(
            function (e) {
              ...
              (a.forcehover = o.force),
                ...
                (a.hoverzIndex ||
                  ...
                  0 === o.speed && (a.inhoverinanimation = !1),
            ...
            function (e) {
              ...
              (a.hoveredstatus = !1),
                ...
                0 == o.speed && (a.inhoveroutanimation = !1),
        ...
        for (var c = 0; c < r.frames.length; c++)
          if (c !== r.hoverframeindex) {
            var f =
              c === r.inframeindex
                ? "frame_0"
                : c === r.outframeindex || "frame_999" === r.frames[c].frame
                ? "frame_999"
                : "frame_" + c;
            (r.frames[c].framename = f),
              (i[f] = {}),
              (i[f].timeline = new punchgs.TimelineLite({ align: "normal" }));
            var u = r.frames[c].delay,
              v =
                (r.triggered_startstatus,
                void 0 !== u
                  ? jQuery.inArray(u, ["slideenter", "bytrigger", "wait"]) >= 0
                    ? u
                    : parseInt(u, 0) / 1e3
                  : "wait");
            void 0 !== i.firstslide &&
    ...
    createFrameOnTimeline: function (e) {
      ...
      if (
        ...
        -1 !== t.hoverframeindex && t.hoverframeindex == y && (y -= 1),
        (h.content = new punchgs.TimelineLite({ align: "normal" })),
        (h.mask = new punchgs.TimelineLite({ align: "normal" })),
        void 0 === s.vars.id && (s.vars.id = Math.round(1e5 * Math.random())),
        "column" === t._nctype &&
          (s.add(
            punchgs.TweenLite.set(t._cbgc_man, { visibility: "visible" }),
            a
          ),
          s.add(
            punchgs.TweenLite.set(t._cbgc_auto, { visibility: "hidden" }),
            a
          )),
        t.splittext && 0 === d)
      ) {
      ...
      void 0 !== t.mySplitText &&
        w &&
        w.match(/chars|words|lines/g) &&
        ((g = t.mySplitText[w]), (k = !0));
      var L,
        I,
        W =
          d !== t.outframeindex
            ? _(c(), t.frames[d].to, void 0, k, g.length - 1)
            : void 0 !== t.frames[d].to &&
              null === t.frames[d].to.match(/auto:auto/g)
            ? _(f(), t.frames[d].to, 1 == p.sdir, k, g.length - 1)
            : _(
                f(),
                t.frames[t.inframeindex].from,
                0 == p.sdir,
                k,
                g.length - 1
              ),
        R =
          void 0 !== t.frames[d].from
            ? _(W, t.frames[t.inframeindex].from, 1 == p.sdir, k, g.length - 1)
            : void 0,
        C = t.frames[d].splitdelay;
      if (
        (0 !== d || e.fromcurrentstate
          ? (I = b(t.frames[d].mask))
          : (L = b(t.frames[d].mask)),
        (W.anim.ease =
          void 0 === t.frames[d].ease
        ...
        void 0 !== R &&
          ((R.anim.ease =
            void 0 === t.frames[d].ease
              ...
              : t.frames[d].ease),
          (R.speed =
            void 0 === t.frames[d].speed ? R.speed : t.frames[d].speed),
          (R.anim.x =
            R.anim.x * p.bw ||
            v(R.anim.x, p, t.eow, t.eoh, t.calcy, t.calcx, "horizontal")),
          (R.anim.y =
            R.anim.y * p.bw ||
            v(R.anim.y, p, t.eow, t.eoh, t.calcy, t.calcx, "vertical"))),
        void 0 !== W &&
          ((W.anim.ease =
            void 0 === t.frames[d].ease
              ? punchgs.Power1.easeInOut
              : t.frames[d].ease),
          (W.speed =
            void 0 === t.frames[d].speed ? W.speed : t.frames[d].speed),
          (W.anim.x =
            W.anim.x * p.bw ||
            v(W.anim.x, p, t.eow, t.eoh, t.calcy, t.calcx, "horizontal")),
          (W.anim.y =
            W.anim.y * p.bw ||
            v(W.anim.y, p, t.eow, t.eoh, t.calcy, t.calcx, "vertical"))),
        i.data("iframes") &&
          s.add(
            punchgs.TweenLite.set(i.find("iframe"), { autoAlpha: 1 }),
            a + "+=0.001"
          ),
        d === t.outframeindex &&
          (t.frames[d].to && t.frames[d].to.match(/auto:auto/g),
          (W.speed =
            void 0 === t.frames[d].speed || "inherit" === t.frames[d].speed
              ? t.frames[t.inframeindex].speed
              : t.frames[d].speed),
          (W.anim.ease =
            void 0 === t.frames[d].ease || "inherit" === t.frames[d].ease
              ? t.frames[t.inframeindex].ease
              : t.frames[d].ease),
          (W.anim.overwrite = "auto")),
        0 !== d || e.fromcurrentstate)
      )
        0 === d && e.fromcurrentstate && (W.speed = R.speed);
      else {
        if (g != i) {
          var z = jQuery.extend({}, W.anim, !0);
          s.add(punchgs.TweenLite.set(i, W.anim), a),
            ((W = c()).ease = z.ease),
      ...
      if (
        ...
        var Q = 0 === d ? R.speed / 1e3 / 2 : W.speed / 1e3 / 2,
          S = [
            ...
            { scaleY: 1, scaleX: 1, ease: W.anim.ease },
          ],
          M = {
            scaleY: 1,
            scaleX: 0,
        ...
        switch (((O = void 0 === C ? Q : C + Q), T)) {
          ...
          case "blocktobottom":
            (S = [
              ...
              { scaleX: 1, scaleY: 1, ease: W.anim.ease },
            ]),
              (M = {
                scaleX: 1,
                scaleY: 0,
        ...
        (S[0].background = t.frames[d].sfxcolor),
          s.add(h.mask.fromTo(t._bmask, Q, S[0], S[1], C), a),
          s.add(h.mask.to(t._bmask, Q, M, O), a);
      }
      if (k) var P = l(g.length - 1, x);
      if (0 !== d || e.fromcurrentstate)
        if ("block" === t._sfx_out && d === t.outframeindex)
          s.add(h.content.staggerTo(g, 0.001, { autoAlpha: 0, delay: O }), a),
            s.add(
              h.content.staggerTo(g, W.speed / 1e3 / 2 - 0.001, {
                x: 0,
                delay: O,
              }),
              a + "+=0.001"
          ...
          for (var A in g) {
            ...
            void 0 !== t.frames[d].color && (Y.color = t.frames[d].color),
              void 0 !== t.frames[d].bgcolor &&
                (Y.backgroundColor = t.frames[d].bgcolor),
              s.add(h.content.to(g[P[A]], W.speed / 1e3, Y, C * A), a);
          }
        } else
          void 0 !== t.frames[d].color && (W.anim.color = t.frames[d].color),
            void 0 !== t.frames[d].bgcolor &&
              (W.anim.backgroundColor = t.frames[d].bgcolor),
            s.add(h.content.staggerTo(g, W.speed / 1e3, W.anim, C), a);
      else if ("block" === t._sfx_in)
        s.add(
          h.content.staggerFromTo(
            g,
            0.05,
            { x: 0, y: 0, autoAlpha: 0 },
            { x: 0, y: 0, autoAlpha: 1, delay: O }
          ),
          a
        );
      else if (k && void 0 !== P) {
        var F = { from: m(R.anim), to: m(W.anim) };
        for (var A in g) {
          ...
          (Y.ease = X.ease),
            void 0 !== t.frames[d].color &&
              ((X.color = t.frames[d].color),
              (Y.color = t.cssobj.styleProps.color)),
            void 0 !== t.frames[d].bgcolor &&
              ((X.backgroundColor = t.frames[d].bgcolor),
              (Y.backgroundColor = t.cssobj.styleProps["background-color"])),
            s.add(h.content.fromTo(g[P[A]], R.speed / 1e3, X, Y, C * A), a);
        }
      } else
        void 0 !== t.frames[d].color &&
          ((R.anim.color = t.frames[d].color),
          (W.anim.color = t.cssobj.styleProps.color)),
          void 0 !== t.frames[d].bgcolor &&
            ((R.anim.backgroundColor = t.frames[d].bgcolor),
            (W.anim.backgroundColor = t.cssobj.styleProps["background-color"])),
          s.add(
            h.content.staggerFromTo(g, R.speed / 1e3, R.anim, W.anim, C),
            a
          );
      return (
        void 0 === I ||
          !1 === I ||
          (0 === d && e.ignorefirstframe) ||
          ((I.anim.ease =
          ...
          (I.anim.x =
            I.anim.x * p.bw ||
            v(I.anim.x, p, t.eow, t.eoh, t.calcy, t.calcx, "horizontal")),
          (I.anim.y =
            I.anim.y * p.bw ||
            v(I.anim.y, p, t.eow, t.eoh, t.calcy, t.calcx, "vertical"))),
        (0 === d && L && !1 !== L && !e.fromcurrentstate) ||
        (0 === d && e.ignorefirstframe)
          ? (((I = new Object()).anim = new Object()),
            ...
            L &&
              ...
              ((L.anim.x =
                L.anim.x * p.bw ||
                v(L.anim.x, p, t.eow, t.eoh, t.calcy, t.calcx, "horizontal")),
              (L.anim.y =
                L.anim.y * p.bw ||
                v(L.anim.y, p, t.eow, t.eoh, t.calcy, t.calcx, "vertical")),
              (L.anim.overflow = "hidden")))
          : 0 === d && s.add(h.mask.set(t._mw, { overflow: "visible" }), a),
        void 0 !== L && void 0 !== I && !1 !== L && !1 !== I
          ? s.add(h.mask.fromTo(t._mw, R.speed / 1e3, L.anim, I.anim, C), a)
          : void 0 !== I &&
            !1 !== I &&
            s.add(h.mask.to(t._mw, W.speed / 1e3, I.anim, C), a),
        s.addLabel(a + "_end"),
        t._gsTransformTo &&
          d === y &&
          t.hoveredstatus &&
          (t.hovertimelines.item = punchgs.TweenLite.to(
            i,
            0,
            t._gsTransformTo
          )),
        (t._gsTransformTo = !1),
        h.content.eventCallback("onStart", o, [
          d,
          u,
          t._pw,
          t,
        ...
        h.content.eventCallback("onUpdate", r, [
          a,
          t._id,
          t._pw,
          t,
        ...
        h.content.eventCallback("onComplete", n, [
          d,
          t.frames.length,
          y,
          t._pw,
    ...
    endMoveCaption: function (e) {
      ...
      if (
        ...
        for (var o = 0; o < i.timeline_obj.dchildren.length; o++)
          t.endMoveCaption({
    ...
    playAnimationFrame: function (e) {
      ...
      void 0 !== o.triggeredtimeline && o.triggeredtimeline.pause(),
        (o.triggeredtimeline = new punchgs.TimelineLite()),
        a.timeline.pause();
      var d = !0 === o.visibleelement;
      o.triggeredtimeline = t
        .createFrameOnTimeline({
          caption: e.caption,
    ...
    removeTheCaptions: function (e, i) {
      ...
      var o = e.data("index"),
        r = new Array();
      i.layers[o] &&
        jQuery.each(i.layers[o], function (e, i) {
          r.push(i);
        });
        ...
        jQuery.each(r, function (e) {
          ...
          "carousel" === i.sliderType && "on" === i.carousel.showLayersAllTime
            ? (clearTimeout(a.data("videoplaywait")),
              t.stopVideo && t.stopVideo(a, i),
              t.removeMediaFromList && t.removeMediaFromList(a, i),
              (i.lastplayedvideos = []))
            : (W(a),
              clearTimeout(a.data("videoplaywait")),
              t.endMoveCaption({ caption: a, opt: i, currentslide: n }),
              t.removeMediaFromList && t.removeMediaFromList(a, i),
              (i.lastplayedvideos = []));
        });
    },
  ...
  var o = function (e, i, a, o, r, n, s, d, l) {
      ...
      if (
        ...
        "on" == o.loopanimation && I(o._lw, l.bw),
        "enterstage" === m.eventtype &&
          ((o.animdirection = "in"),
          (o.visibleelement = !0),
          t.toggleState(o.layertoggledby)),
        "none" !== i.dchildren &&
          void 0 !== i.dchildren &&
    ...
    r = function (e, i, t, a, o, r, n, s, d, l) {
      "column" === a._nctype && L(d, l),
        punchgs.TweenLite.set(t, { visibility: "visible" }),
        (a.current_frame = r),
        (a.current_timeline = o),
        (a.current_timeline_time = o.time()),
    ...
    n = function (e, i, a, o, r, n, s, d, l) {
      ...
      (m.layer = d),
        ...
        "column" === r._nctype &&
          (punchgs.TweenLite.to(r._cbgc_man, 0.01, { visibility: "hidden" }),
          punchgs.TweenLite.to(r._cbgc_auto, 0.01, { visibility: "visible" })),
        "leftstage" === m.eventtype &&
          ((r.active = !1),
          punchgs.TweenLite.set(o, { visibility: "hidden", overwrite: "auto" }),
          (r.animdirection = "out"),
          (r.visibleelement = !1),
          t.unToggleState(r.layertoggledby)),
        (r.current_frame = e),
        (r.current_timeline = n),
        (r.current_timeline_time = n.time()),
    ...
    s = function (e) {
      ...
      return (
        ...
        (i.id = e.caption.data("id") || e.caption.attr("id")),
        (i.slideid =
          e.caption.data("slideid") ||
          e.caption.closest(".tp-revslider-slidesli").data("index")),
        (i.timeline_obj = e.opt.timelines[i.slideid].layers[i.id]),
        (i.timeline = i.timeline_obj.timeline),
        (i.ffs = i.timeline.getLabelTime(e.firstframe)),
        (i.ffe = i.timeline.getLabelTime(e.firstframe + "_end")),
        (i.lfs = i.timeline.getLabelTime(e.lastframe)),
        (i.lfe = i.timeline.getLabelTime(e.lastframe + "_end")),
        (i.ct = i.timeline.time()),
        (i.static =
          void 0 != i.timeline_obj.firstslide ||
          void 0 != i.timeline_obj.lastslide),
        i.static &&
          ((i.showonslide = i.timeline_obj.firstslide),
          (i.removeonslide = i.timeline_obj.lastslide)),
        i
      );
    },
    d = function (e) {
      for (var i, t, a = e.length; 0 !== a; )
    ...
    l = function (e, i) {
      ...
      switch (i) {
        ...
        case "middletoedge":
          ...
          t.push(a);
          for (n = 0; n < a; n++)
            o >= 0 && t.push(o), r <= e && t.push(r), o--, r++;
          break;
        case "edgetomiddle":
          for (var o = e, r = 0, n = 0; n <= Math.floor(e / 2); n++)
            t.push(o), r < o && t.push(r), o--, r++;
      }
      return t;
    },
    m = function (e) {
      ...
      for (var t in e)
        "string" == typeof e[t] &&
          e[t].indexOf("|") >= 0 &&
          (void 0 === i[t] && (i[t] = { index: 0 }),
          (i[t].values = e[t].replace("[", "").replace("]", "").split("|")),
          (i[t].len = i[t].values.length - 1));
      return i;
    },
    c = function (e) {
      return (
        ...
        t &&
          jQuery.each(t, function (e, t) {
            var a = t.split(":"),
              o = a[0],
              r = a[1];
            "sc" == o && (i.anim.stroke = r),
              "sw" == o && (i.anim.strokeWidth = r),
              "sda" == o && (i.anim.strokeDasharray = r),
              "sdo" == o && (i.anim.strokeDashoffset = r);
          }),
        i
      );
    },
    ...
    u = function (e, i, t, a, o) {
      if (((o = void 0 === o ? "" : o), jQuery.isNumeric(parseFloat(e))))
      ...
      if (e.split("{").length > 1) {
        ...
        if (
          ((r = parseFloat(r[0].split("{")[1])), void 0 !== t && void 0 !== a)
        ) {
    ...
    v = function (e, i, t, a, o, r, n) {
      return (
        !jQuery.isNumeric(e) && e.match(/%]/g)
          ? ((e = e.split("[")[1].split("]")[0]),
            "horizontal" == n
              ? (e = ((t + 2) * parseInt(e, 0)) / 100)
              : "vertical" == n && (e = ((a + 2) * parseInt(e, 0)) / 100))
          : (e =
              "top" ===
                (e =
                  "left" ===
          ...
          jQuery.each(n, function (e, i) {
            ...
            t &&
              ...
              void 0 != l &&
                ((l = l.replace(/\(R\)/, "")),
                ("rotationX" != d && "rX" != d) ||
                  (r.anim.rotationX = u(l, r.anim.rotationX, a, o, "deg")),
                ("rotationY" != d && "rY" != d) ||
                  (r.anim.rotationY = u(l, r.anim.rotationY, a, o, "deg")),
                ("rotationZ" != d && "rZ" != d) ||
                  (r.anim.rotation = u(l, r.anim.rotationZ, a, o, "deg")),
                ("scaleX" != d && "sX" != d) ||
                  (r.anim.scaleX = u(l, r.anim.scaleX, a, o)),
                ("scaleY" != d && "sY" != d) ||
                  (r.anim.scaleY = u(l, r.anim.scaleY, a, o)),
                ("opacity" != d && "o" != d) ||
                  (r.anim.opacity = u(l, r.anim.opacity, a, o)),
                "fb" == d &&
                  (s =
                    "" === s
                ...
                ("skewX" != d && "skX" != d) ||
                  (r.anim.skewX = u(l, r.anim.skewX, a, o)),
                ("skewY" != d && "skY" != d) ||
                  (r.anim.skewY = u(l, r.anim.skewY, a, o)),
                "x" == d && (r.anim.x = u(l, r.anim.x, a, o)),
                "y" == d && (r.anim.y = u(l, r.anim.y, a, o)),
                "z" == d && (r.anim.z = u(l, r.anim.z, a, o)),
      ...
      return (
        t &&
          jQuery.each(t, function (e, t) {
            ...
            "x" == a && (i.anim.x = o),
              "y" == a && (i.anim.y = o),
              "s" == a && (i.speed = parseFloat(o)),
              ("e" != a && "ease" != a) || (i.anim.ease = o);
          }),
        i
      );
    },
    y = function (e, i, t) {
      if (
        ...
        e = e.replace("[", "");
        var a = (e = e.replace("]", "")).match(/'/g)
          ? e.split("',")
          : e.split(",");
        (e = new Array()),
          a &&
            jQuery.each(a, function (i, t) {
      ...
      var o = e[e.length - 1];
      if (e.length < i.rle) for (var r = 1; r <= i.curWinRange; r++) e.push(o);
      return e;
    },
    w = function (e, i) {
      if (void 0 === i) return e;
      var t = (i = (i = (i = (i = (i = (i = (i = (i = i.replace(
        "c:",
        "color:"
    ...
    x = function (e, i) {
      ...
      if (
        ("rekursive" == i &&
          (t = e.closest(".tp-caption")) &&
          e.css("fontSize") === t.css("fontSize") &&
          e.css("fontWeight") === t.css("fontWeight") &&
          e.css("lineHeight") === t.css("lineHeight") &&
          (o = !0),
        ...
        (a.whiteSpace = o
          ...
          : e.data("whitespace")),
        (a.textAlign = o
          ? void 0 === t.data("textalign")
            ? t.css("textalign") || "inherit"
            : t.data("textalign")
    ...
    k = function (e, i, t, a) {
      return (
        (e = jQuery.isNumeric(e) ? e * i + "px" : e),
        (e = "full" === e ? a : "auto" === e || "none" === e ? t : e)
      );
    },
    j = function (e, i, t, a) {
      var o = e.data();
      ...
      if (
        ("column" === o._nctype &&
          (punchgs.TweenLite.set(o._column, {
        ...
        if (
          ...
          if (
            ...
            o._isgroup &&
              ...
              "#4/6#" === g && (g = c = (l / 6) * 4),
              "#5/6#" === g && (g = c = (l / 6) * 5)),
            o._ingroup && ((o._groupw = g), (o._grouph = f)),
            punchgs.TweenLite.set(e, {
              maxWidth: c,
              maxHeight: p,
              minWidth: g,
    ...
    L = function (e, i) {
      ...
      if (t._cbgc_man && t._cbgc_man.length > 0) {
        var a, o, r;
        jQuery.isArray(t.cssobj.marginLeft)
          ? (t.cssobj.marginLeft[i.curWinRange] * i.bw,
            (a = t.cssobj.marginTop[i.curWinRange] * i.bh),
            (o = t.cssobj.marginBottom[i.curWinRange] * i.bh),
            t.cssobj.marginRight[i.curWinRange] * i.bw)
          : (t.cssobj.marginLeft * i.bw,
            (a = t.cssobj.marginTop * i.bh),
            (o = t.cssobj.marginBottom * i.bh),
            t.cssobj.marginRight * i.bw),
          (r = t._row.hasClass("rev_break_columns")
            ? "100%"
            : t._row.height() - (a + o) + "px"),
          (t._cbgc_man[0].style.backgroundSize = t._column_bg_image_size),
          punchgs.TweenLite.set(t._cbgc_man, {
            width: "100%",
            height: r,
    ...
    I = function (e, i) {
      ...
      if (e.hasClass("rs-pendulum") && void 0 == t._loop_timeline) {
        ...
        (a *= i),
          (o *= i),
          t._loop_timeline.append(
            new punchgs.TweenLite.fromTo(
              e,
              r,
              { force3D: "auto", rotation: a, transformOrigin: n },
              { rotation: o, ease: s }
            )
          ),
          t._loop_timeline.append(
      ...
      if (e.hasClass("rs-wave") && void 0 == t._loop_timeline) {
        ...
        var f = void 0 == e.data("angle") ? 10 : parseInt(e.data("angle"), 0),
          ...
          u = (n =
            void 0 == e.data("origin") ? "50% 50%" : e.data("origin")).split(
            " "
          ),
          v = new Object();
        u.length >= 1
        ...
        var _ = {
            ...
            yoffset: -1 * h + (parseInt(v.y, 0) / 100 - 0.5) * e.height(),
          },
          b = parseInt(f, 0),
          y = new punchgs.TweenLite.fromTo(
            ...
            r,
            { a: 0 + b },
            { a: 360 + b, force3D: "auto", ease: punchgs.Linear.easeNone }
          );
        y.eventCallback(
          "onUpdate",
          function (e) {
